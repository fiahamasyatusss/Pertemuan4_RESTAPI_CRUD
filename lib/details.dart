...
import 'package:latihan_pertemuan4/edit.dart';
import 'package:latihan_pertemuan4/main.dart';
...
class _DetailsState extends State<Details> {
  void delete() {
    var url = Uri.parse('http://192.168.1.9/restapi/delete.php'); //deletion api
